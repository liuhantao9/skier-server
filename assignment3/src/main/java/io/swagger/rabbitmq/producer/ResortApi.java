...
public interface ResortApi {
    ...
    ResponseEntity<TopTen> getTopTenVert(@NotNull @ApiParam(value = "resort to query by", required = true) @Valid @RequestParam(value = "resortID", required = true) String resortID
